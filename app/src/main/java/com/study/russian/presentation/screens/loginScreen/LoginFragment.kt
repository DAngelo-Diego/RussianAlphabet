...
import com.study.russian.presentation.screens.homeScreen.HomeActivity
import com.study.russian.util.Constants.USER_NOT_EXISTS
import com.study.russian.util.Constants.WRONG_PASSWORD
import com.study.russian.util.DataState
import com.study.russian.util.isInputEmpty
import com.study.russian.util.toast
    ...
    private fun isUserDataOk(): Boolean{
        return when{
            ...
            requireActivity().isInputEmpty(binding.etPassword, true) -> {
                ...
                true // The user enters all the data
            }
        }
    }
